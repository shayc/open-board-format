...
This list will probably grow over time, and will be split into suggested and optional actions. In the mean time, if you have actions that are custom to your app, you can use the `ext_` notation [covered in more detail below](#extensions) (in this case still prefaced by a colon).
