...
- ef2482d: First stable release. The public API — every exported function, type, and Zod schema — is now covered by semver; breaking changes will ship as major versions.
